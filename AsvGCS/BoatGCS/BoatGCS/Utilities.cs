...
namespace BoatGCS
{
    ...
    public class PointLatLngAlt: IComparable
    {
        ...
        public double GetDistance2(PointLatLngAlt p2)
        {
            ...
            var dLat = (p2.Lat - Lat) * deg2rad;//两点间的纬度差[弧度]
            var dLon = (p2.Lng - Lng) * deg2rad;//两点间的经度差[弧度]
        ...
        /// 计算两点间距离[m]...by fei
        /// </summary>
        public double GetDistance3(PointLatLngAlt p2)
        {
            var R = 6371.0; // 6371 km
            var dLat = (p2.Lat - Lat) * deg2rad;//两点间的纬度差[弧度]
            var dLon = (p2.Lng - Lng) * deg2rad;//两点间的经度差[弧度]
